/**
  ******************************************************************************
  * @file    test_network_model.h
  * @author  AST Embedded Analytics Research Platform
  * @date    Wed May 19 21:45:07 2021
...
#ifndef AI_TEST_NETWORK_MODEL_H
#define AI_TEST_NETWORK_MODEL_H
#pragma once

#include "test_network_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TEST_NETWORK_MODEL_MODEL_NAME          "test_network_model"
#define AI_TEST_NETWORK_MODEL_ORIGIN_MODEL_NAME   "mfcc"

/******************************************************************************/
#define AI_TEST_NETWORK_MODEL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_TEST_NETWORK_MODEL_IN_NUM        (1)
#define AI_TEST_NETWORK_MODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 156, 13, 1, 1, NULL), \
}
#define AI_TEST_NETWORK_MODEL_IN_SIZE { \
  AI_TEST_NETWORK_MODEL_IN_1_SIZE, \
}
#define AI_TEST_NETWORK_MODEL_IN_SIZE_BYTES { \
  AI_TEST_NETWORK_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_TEST_NETWORK_MODEL_IN_1_HEIGHT      (156)
#define AI_TEST_NETWORK_MODEL_IN_1_WIDTH       (13)
#define AI_TEST_NETWORK_MODEL_IN_1_CHANNEL     (1)
#define AI_TEST_NETWORK_MODEL_IN_1_SIZE        (156 * 13 * 1)
#define AI_TEST_NETWORK_MODEL_IN_1_SIZE_BYTES  (AI_TEST_NETWORK_MODEL_IN_1_SIZE * 1)

/******************************************************************************/
#define AI_TEST_NETWORK_MODEL_OUT_NUM       (1)
#define AI_TEST_NETWORK_MODEL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 1, 1, 2, 1, NULL), \
}
#define AI_TEST_NETWORK_MODEL_OUT_SIZE { \
  AI_TEST_NETWORK_MODEL_OUT_1_SIZE, \
}
#define AI_TEST_NETWORK_MODEL_OUT_SIZE_BYTES { \
  AI_TEST_NETWORK_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_TEST_NETWORK_MODEL_OUT_1_HEIGHT      (1)
#define AI_TEST_NETWORK_MODEL_OUT_1_WIDTH       (1)
#define AI_TEST_NETWORK_MODEL_OUT_1_CHANNEL     (2)
#define AI_TEST_NETWORK_MODEL_OUT_1_SIZE        (1 * 1 * 2)
#define AI_TEST_NETWORK_MODEL_OUT_1_SIZE_BYTES  (AI_TEST_NETWORK_MODEL_OUT_1_SIZE * 1)

/******************************************************************************/
#define AI_TEST_NETWORK_MODEL_N_NODES (9)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup test_network_model
 ...
 */
AI_API_ENTRY
ai_bool ai_test_network_model_get_info(
 ...
 */
AI_API_ENTRY
ai_error ai_test_network_model_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_test_network_model_create(
 ...
 */
AI_API_ENTRY
ai_handle ai_test_network_model_destroy(ai_handle network);

/*!
 * @brief Initialize the data structures of the network.
 * @ingroup test_network_model
 * @details This API initialized the network after a successfull
 * @ref ai_test_network_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_test_network_model_get_error
 */
AI_API_ENTRY
ai_bool ai_test_network_model_init(
 ...
 * header generated by the code generation tool. See AI_TEST_NETWORK_MODEL_*
 * defines into file @ref test_network_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_test_network_model_run(
 ...
 */
AI_API_ENTRY
ai_i32 ai_test_network_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TEST_NETWORK_MODEL_H */

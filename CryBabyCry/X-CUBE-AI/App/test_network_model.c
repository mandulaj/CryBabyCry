...
#define AI_NET_OBJ_INSTANCE g_test_network_model
 
#undef AI_TEST_NETWORK_MODEL_MODEL_SIGNATURE
#define AI_TEST_NETWORK_MODEL_MODEL_SIGNATURE     "79b127b78a83b076c9f4d1fdc71aa75e"
...
#define AI_TOOLS_DATE_TIME   "Wed May 19 21:45:07 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_TEST_NETWORK_MODEL_N_BATCHES
#define AI_TEST_NETWORK_MODEL_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 8208, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_TEST_NETWORK_MODEL_IN_NUM, &conv2d_4_input_int8_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_TEST_NETWORK_MODEL_OUT_NUM, &nl_10_fmt_output),
  &conv2d_0_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool test_network_model_configure_activations(
...
AI_DECLARE_STATIC
ai_bool test_network_model_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_TEST_NETWORK_MODEL_MODEL_NAME,
      .model_signature   = AI_TEST_NETWORK_MODEL_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= test_network_model_configure_weights(net_ctx, &params->params);
  ok &= test_network_model_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_test_network_model_forward(ai_handle network, const ai_buffer* input)
{
